...
export interface CMChatMemberSearchFilterInput {
...
export interface ChannelMember extends Node {
  ...
  channelId: string
  chatMemberId: string
  chatMember?: Nullable<ChatMember>
...
export interface CMMyChannelOutput extends ResponseFormat {
  isSuccess: boolean
  code: number
  errorMessage?: Nullable<string>
  pagination?: Nullable<PaginationOutput>
...
export interface IQuery {
  ...
  usersGet(
    userArrayFilterInput?: Nullable<UserArrayFilterInput>
  ): Nullable<UserSafeArrayOutput> | Promise<Nullable<UserSafeArrayOutput>>
  userProfilesGet(
    userProfileFilterInput?: Nullable<UserProfileFilterInput>
  ): UserProfileArrayOutput | Promise<UserProfileArrayOutput>
  userProfileGet(userId: string): Nullable<UserProfileOutput> | Promise<Nullable<UserProfileOutput>>
  eventTokensGet(
    eventTokenArrayFilterInput?: Nullable<EventTokenArrayFilterInput>
  ): EventTokenArrayOutput | Promise<EventTokenArrayOutput>
  ...
  umDevUsersGet(
    userArrayFilterInput?: Nullable<UserArrayFilterInput>
  ): Nullable<UserArrayOutput> | Promise<Nullable<UserArrayOutput>>
  organizationsGet(
    organizationFilterInput?: Nullable<OrganizationFilterInput>
  ): OrganizationArrayOutput | Promise<OrganizationArrayOutput>
  ...
  chatAppTokensGet(
    chatAppTokenFilterInput?: Nullable<ChatAppTokenFilterInput>
  ): ChatAppTokenArrayOutput | Promise<ChatAppTokenArrayOutput>
  chatAppTokenGet(id: string): Nullable<ChatAppTokenOutput> | Promise<Nullable<ChatAppTokenOutput>>
  chatMembersGet(
    chatMemberFilterInput?: Nullable<ChatMemberFilterInput>
  ): ChatMemberArrayOutput | Promise<ChatMemberArrayOutput>
  chatMemberGet(id: string): Nullable<ChatMemberOutput> | Promise<Nullable<ChatMemberOutput>>
  chatMemberTokenVerify(
    token: string
  ): Nullable<ChatMemberTokenVerifyOutput> | Promise<Nullable<ChatMemberTokenVerifyOutput>>
  chatMemberTokensGet(
    chatMemberTokenFilterInput?: Nullable<ChatMemberTokenFilterInput>
  ): ChatMemberTokenArrayOutput | Promise<ChatMemberTokenArrayOutput>
  ...
  channelMembersGet(
    channelMemberFilterInput?: Nullable<ChannelMemberFilterInput>
  ): ChannelMemberArrayOutput | Promise<ChannelMemberArrayOutput>
  channelMemberGet(id: string): Nullable<ChannelMemberOutput> | Promise<Nullable<ChannelMemberOutput>>
  channelMessagesGet(
    channelMessageFilterInput?: Nullable<ChannelMessageFilterInput>
...
export interface IMutation {
  ...
  ): UserSafeOutput | Promise<UserSafeOutput>
  ...
  umDevFirebaseEmailPasswordUserCreate(
    umFirebaseEmailPasswordUserCreateInput: UMFirebaseEmailPasswordUserCreateInput
  ): UserSafeOutput | Promise<UserSafeOutput>
  userProfileUpdateByUser(
    userProfileUpdateInput: UserProfileUpdateInput
  ): UserProfileOutput | Promise<UserProfileOutput>
  ...
  organizationCreate(
    organizationCreateInput?: Nullable<OrganizationCreateInput>
  ): OrganizationOutput | Promise<OrganizationOutput>
  organizationDeleteById(id: string): OrganizationOutput | Promise<OrganizationOutput>
  chatAppTokenCreate(
    chatAppTokenCreateInput?: Nullable<ChatAppTokenCreateInput>
  ): ChatAppTokenOutput | Promise<ChatAppTokenOutput>
  chatAppTokenDeleteById(id: string): ChatAppTokenOutput | Promise<ChatAppTokenOutput>
  chatMemberCreate(
    chatMemberCreateInput?: Nullable<ChatMemberCreateInput>
  ): ChatMemberOutput | Promise<ChatMemberOutput>
  chatMemberDeleteById(id: string): ChatMemberOutput | Promise<ChatMemberOutput>
  chatMemberTokenCreate(
    chatMemberTokenCreateInput?: Nullable<ChatMemberTokenCreateInput>
  ): ChatMemberTokenOutput | Promise<ChatMemberTokenOutput>
  ...
  ): ChannelMessageOutput | Promise<ChannelMessageOutput>
  cmGroupChannelGetOrCreate(
    cmGroupChannelCreateInput: CMGroupChannelCreateInput
  ): CMMyChannelOutput | Promise<CMMyChannelOutput>
  cmPeerChannelGetOrCreate(
