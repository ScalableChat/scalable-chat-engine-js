...
export interface IQuery {
  ...
  cmMyChannels(cmMyChannelsFilterInput?: Nullable<CMMyChannelsFilterInput>): CMMyChannelArrayOutput | Promise<CMMyChannelArrayOutput>;
  ...
  cmChatMembersSearch(cmChatMemberSearchFilterInput: CMChatMemberSearchFilterInput): ChatMemberArrayOutput | Promise<ChatMemberArrayOutput>;
}
...
export interface IMutation {
  ...
  cmGroupChannelGetOrCreate(cmGroupChannelCreateInput: CMGroupChannelCreateInput): CMMyChannelOutput | Promise<CMMyChannelOutput>;
  cmPeerChannelGetOrCreate(cmPeerChannelCreateInput: CMPeerChannelCreateInput): CMMyChannelOutput | Promise<CMMyChannelOutput>;
}
